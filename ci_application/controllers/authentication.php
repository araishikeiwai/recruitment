            ...
            if ($username == 'admin') {
                ...
                if ($ldap_result == 'error_username') {
                    ...
                    if ($query -> num_rows() == 0) {
                        ...
                        $pesan['isi'] = 'Halo, ' . $data['nama'] . '!<br/><br/>Selamat datang di sistem informasi rekrutmen ini!<br/>Beberapa hal yang bisa Anda lakukan dalam sistem ini diantaranya:<ul><li>Melengkapi <a target="_blank" href="' . base_url() . 'profil/ubah">profil</a> dan <a target="_blank" href="' . base_url() . 'cv/ubah">CV</a> Anda</li><li><a target="_blank" href="' . base_url() . 'cari">Mencari lowongan yang telah dibuka</a></li><li>Mendaftar lowongan</li><li><a target="_blank" href="' . base_url() . 'profil/ubah">Membuka lowongan baru (harus mengupgrade status sebagai provider terlebih dahulu)</a></li><li>Mempromosikan lowongan yang Anda buka</li><li>Dan lain-lain</li></ul><br/>Selamat mengeksplorasi dan mempergunakan sistem ini. Semoga berguna :D<br/><br/>Tim Pengembang recrUItment<br/><br/><i><b>NB: Gunakan browser Google Chrome atau Opera untuk hasil terbaik.</b></i>';
