...
--
-- Host: localhost
-- Generation Time: May 25, 2013 at 07:46 AM
...
(1, 'Lowongan', 'diajukan promosi', 'Kepanitiaan', '<p>Asik</p>', '0', '2013-09-19', 'ricky.arifandi', 'Vokasi Mahasiswa2008 Mahasiswa2010 Pria Wanita Islam Kristen Katolik Buddha Hindu Konghucu Lainnya ', 15, 25, 0);
...
(1, 4, 'diajukan promosi', '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `promosi_paket` (
  ...
  `biaya_promosi` int(255) NOT NULL,
